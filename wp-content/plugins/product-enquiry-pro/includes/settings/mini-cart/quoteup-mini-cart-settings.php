...
function miniCartSettingsSection($form_data)
{
    ...
    ?>
        ...
        <div class="fd">
            <div class='left_div'>
                <label for="enable_disable_mini_cart"> <?php _e('Enable Mini Cart', QUOTEUP_TEXT_DOMAIN) ?> </label>
            </div>
        ...
        <div class="fd">
            <div class='left_div'>
                <label for="wdm_cart_position"> <?php _e('Cart Position', QUOTEUP_TEXT_DOMAIN) ?> </label>
            </div>
            <div class='right_div'>
                <?php
                ...
                echo \quoteupHelpTip($helptip, true);
                ?>
                <select name="wdm_form_data[mini_cart_position]" id="mini_cart_position">
