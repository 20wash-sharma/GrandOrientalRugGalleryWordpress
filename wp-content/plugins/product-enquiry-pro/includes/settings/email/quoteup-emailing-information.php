...
function companyLogo($form_data)
{
    ...
    <div class="fd">
        <div class='left_div'>
            <label for="wdm_company_logo"> <?php _e('Company Logo', QUOTEUP_TEXT_DOMAIN) ?> </label>
        </div>
        <div class='right_div help-doc-link-upload-field'>
            <div id="tgm-new-media-settings">
                <input class="wdm_wpi_text input-without-tip" type="text" id="tgm-new-media-image" size="70" value="<?php echo $form_data[ 'company_logo' ] ?>" name="wdm_form_data[company_logo]" /><a href="#" class="tgm-open-media button button-primary wdm-media-upload-button" title="Upload Logo"><?php _e('Upload Image', QUOTEUP_TEXT_DOMAIN) ?></a>
            </div>
        </div>
        <div class='clear'></div>
    </div >
