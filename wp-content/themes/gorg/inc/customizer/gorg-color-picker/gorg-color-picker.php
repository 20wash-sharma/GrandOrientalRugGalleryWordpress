 ...
 */
class Gorg_Customize_Opacity_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'gorg-color-picker-js',
			get_template_directory_uri() . '/inc/customizer/gorg-color-picker/gorg-color-picker.js',
			array( 'jquery', 'wp-color-picker' ),
			'1.0.0',
			true
		);
		wp_enqueue_style(
			'gorg-color-picker-css',
			get_template_directory_uri() . '/inc/customizer/gorg-color-picker/gorg-color-picker.css',
