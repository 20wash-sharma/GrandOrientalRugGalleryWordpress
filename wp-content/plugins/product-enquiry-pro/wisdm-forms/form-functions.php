...
function quoteupEnqueuePhoneFieldsScripts($shouldEnqueueScripts = false)
{
    ...
    if ($shouldEnqueueScripts) {
        // Enqueue style
        wp_enqueue_style('quoteup-int-tel-input-css', QUOTEUP_PLUGIN_URL . '/css/public/quoteup-intlTelInput.css');

        // Enqueue scripts
        wp_enqueue_script('quoteup-int-tel-input-js', QUOTEUP_PLUGIN_URL . '/js/public/intlTelInput.min.js', array('jquery'), false, true);
        wp_enqueue_script('quoteup-int-tel-input-util-js', QUOTEUP_PLUGIN_URL . '/js/public/utils.js', array('jquery'), false, true);
        wp_enqueue_script('quoteup-custom-phone-js', QUOTEUP_PLUGIN_URL . '/js/public/wdm-phone.js', array('jquery', 'quoteup-int-tel-input-js', 'quoteup-int-tel-input-util-js'), false, true);
    }
}
