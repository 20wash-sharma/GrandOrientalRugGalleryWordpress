...
class Assets extends Structure\Component {
    ...
    public function register_assets() {
        ...
        wp_register_script(
            'accounting',
            \WooCommerce::instance()->plugin_url() . '/assets/js/accounting/accounting' . $suffix . '.js',
            [ 'jquery' ],
            '0.4.2'
        );
        ...
        wp_enqueue_script(
            ...
            $this->get_plugin()->get_assets_url() . 'scripts/front-vendor.js',
            [
                'jquery',
                'jquery-ui-slider'
            ]
        ...
        wp_enqueue_script(
            'wcpf-plugin-script',
            $this->get_plugin()->get_assets_url() . 'scripts/plugin.js',
            [
                'jquery',
                'wp-util',
                'jquery-ui-slider',
        ...
        wp_enqueue_style( 'wcpf-plugin-style', $this->get_plugin()->get_assets_url() . 'styles/plugin.css' );
