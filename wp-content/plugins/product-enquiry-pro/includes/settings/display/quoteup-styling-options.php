...
function quoteupShowCustomStylingSetting($form_data, $css_opt)
{
    ...
    ?> checked <?php
        ...
        ?> />
            <?php echo '<em>'.__('  Use Activated Theme CSS ', QUOTEUP_TEXT_DOMAIN).'</em>'; ?><br>
    ...
    ?> checked <?php
        ...
        ?>/>
            ...
            <?php echo '<em>'.__(' Manually specify color settings', QUOTEUP_TEXT_DOMAIN).'</em>'; ?>
        </div>
        <div class="clear"></div>
    </div>
    <?php
...
function quoteupShowEnqCartIconPositionSetting($form_data)
{
    ...
    <div class='fd'>
        ...
        <div class='right_div'>
            ...
            <input type="radio" class="wdm_wpi_input wdm_wpi_checkbox" name="wdm_form_data[ec_icon_pos]" value="icon_top_right"  id="icon_top_right" <?php if ($iconPos == 'icon_top_right' || $iconPos == '') {
    ?> checked <?php
}
    ?>/>
            <?php echo '<em>'.__('Top - Right Position', QUOTEUP_TEXT_DOMAIN).'</em>';
    ?><br>

            <!-- Top - Left Position Setting -->
            <input type="radio" class="wdm_wpi_input wdm_wpi_checkbox" name="wdm_form_data[ec_icon_pos]" value="icon_top_left" id="icon_top_left" <?php if ($iconPos == 'icon_top_left') {
    ?> checked <?php
}
    ?> />
            <?php echo '<em>'.__('  Top - Left Position ', QUOTEUP_TEXT_DOMAIN).'</em>';
    ?><br>

            <!-- Bottom - Left Position -->
            <input type="radio" class="wdm_wpi_input wdm_wpi_checkbox" name="wdm_form_data[ec_icon_pos]" value="icon_bottom_left"  id="icon_bottom_left" <?php if ($iconPos == 'icon_bottom_left') {
    ?> checked <?php
}
    ?>/>
            <?php echo '<em>'.__('Bottom - Left Position', QUOTEUP_TEXT_DOMAIN).'</em>';
    ?><br>

            <!-- Bottom - Right Position -->
            <input type="radio" class="wdm_wpi_input wdm_wpi_checkbox" name="wdm_form_data[ec_icon_pos]" value="icon_bottom_right"  id="icon_bottom_right" <?php if ($iconPos == 'icon_bottom_right') {
    ?> checked <?php
}
    ?>/>
            <?php echo '<em>'.__('Bottom - Right Position', QUOTEUP_TEXT_DOMAIN).'</em>';
    ?><br>    
...
function quoteupShowSpecifyIconColorCheckbox($form_data)
{
    ...
    <div class="fd">
        <div class='left_div'>
            <label for="enable_manual_ec_icon_color"> <?php _e('Specify Icon Color', QUOTEUP_TEXT_DOMAIN); ?> </label>
        </div>
        <div class='right_div'>
            <?php
