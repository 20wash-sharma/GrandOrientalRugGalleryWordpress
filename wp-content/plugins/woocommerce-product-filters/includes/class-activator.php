...
class Activator extends Structure\Component {
    ...
    public function attach_hooks( Structure\Hook_Manager $hook_manager ) {
        register_activation_hook( WC_PRODUCT_FILTER_PLUGIN_FILE, [ $this, 'on_activate_plugin' ] );

        register_deactivation_hook( WC_PRODUCT_FILTER_PLUGIN_FILE, [ $this, 'on_deactivate_plugin' ] );
