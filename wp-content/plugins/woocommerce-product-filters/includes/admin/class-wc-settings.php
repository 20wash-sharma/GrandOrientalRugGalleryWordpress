...
class WC_Settings extends Structure\Component {
    ...
    public function get_settings() {
        ...
        return $this->get_hook_manager()->apply_filters( 'wcpf_wc_filter_settings', [
            'section_title' => [
            ...
            'script_after_updating_products' => [
