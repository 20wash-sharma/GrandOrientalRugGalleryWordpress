...
function quoteupAddProductInEnqCart()
{
    ...
    echo $quoteup->wcCartSession->get('wdm_product_count');
...
function getPriceToSend($priceStatus, $pri, $quant)
{
    if ($priceStatus == 'yes') {
...
function processEnquiryAfterInsertion($enquiryID, $product_details, $quoteup, $validMedia, $data, $authorEmail, $subject)
{
    ...
    do_action('quoteup_send_auto_responder_enquiry_email', $data);
