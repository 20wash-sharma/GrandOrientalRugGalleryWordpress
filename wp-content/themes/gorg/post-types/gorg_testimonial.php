...
function gorg_testimonial_init() {
	register_post_type( 'gorg_testimonial', array(
		'labels'                => array(
			...
			'featured_image'        => _x( 'Featured Image', 'gorg_testimonial', 'gorg' ),
			'set_featured_image'    => _x( 'Set featured image', 'gorg_testimonial', 'gorg' ),
			'remove_featured_image' => _x( 'Remove featured image', 'gorg_testimonial', 'gorg' ),
			'use_featured_image'    => _x( 'Use as featured image', 'gorg_testimonial', 'gorg' ),
