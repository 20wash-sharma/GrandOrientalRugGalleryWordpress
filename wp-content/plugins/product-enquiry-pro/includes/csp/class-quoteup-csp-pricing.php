...
if (! class_exists('QuoteupCSPPricing')) {
    ...
    class QuoteupCSPPricing
    {
        ...
        public function enqueue_admin_scripts($hook)
        {
            ...
            wp_enqueue_script('quoteup-csp-comp-js', QUOTEUP_PLUGIN_URL.'/js/csp/quoteup-csp-quote-creation.js', array('jquery'), filemtime(QUOTEUP_PLUGIN_DIR.'/js/csp/quoteup-csp-quote-creation.js'), true);
