			...
			<div class="sui-box-body">
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						...
						<span class="sui-description"><?php printf ( esc_html__( 'Your WordPress Language Settings are set to %s .' ), esc_html( get_locale() ) ); ?></span>
					</div>
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						<?php
							$available_translations = true;

						if( $available_translations ): ?>
							<div class="sui-notice sui-notice-warning">
								<div class="sui-notice-content">
									<p><?php esc_html_e( 'You have *insert num here* translations ready to update.', 'wpmudev' ); ?></p>
									<button
