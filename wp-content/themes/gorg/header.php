                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="header-top-right">
                            <ul
                                class="list_none social_icons text-center border_social rounded_social social_white  text-md-right mt-2 mt-md-0">
                                <?php if($gorg_facebook):?>
                                <li><a target="_blank" href="<?php echo $gorg_facebook;?>"><i
                                            class="ion-social-facebook"></i></a></li>
                                <?php endif;?>
                                <?php if($gorg_twitter):?>
                                <li><a target="_blank" href="<?php echo $gorg_twitter;?>"><i
                                            class="ion-social-twitter"></i></a></li>
                                <?php endif;?>
                                <?php if($gorg_googleplus): ?>
                                <li><a target="_blank" href="<?php echo esc_url($gorg_googleplus);?>"><i
                                            class="ion-social-googleplus"></i></a></li>
                                <?php endif;?>
                                <?php if($gorg_linkedin):?>
                                <li><a target="_blank" href="<?php echo $gorg_linkedin;?>"><i
                                            class="ion-social-linkedin"></i></a></li>
                                <?php endif;?>
                                <?php if($gorg_yelp): ?>
                                <li><a target="_blank" href="<?php echo esc_url($gorg_yelp);?>"><i
                                            class="fab fa-yelp"></i></a></li>
                                <?php endif;?>
                                <?php if($gorg_youtube):?>
                                <li><a target="_blank" href="<?php echo $gorg_youtube;?>"><i
                                            class="ion-social-youtube-outline"></i></a></li>
                                <?php endif;?>
                                <?php if($gorg_instagram):?>
                                <li><a target="_blank" href="<?php echo $gorg_instagram;?>"><i
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="<?php echo home_url('/');?>">
                    ...
                    <img class="logo_dark" src="<?php if($default_logo_url): echo $default_logo_url; endif;?>"
                        alt="Gorg logo" />
                    <img class="logo_default" src="<?php if($default_logo_url): echo $default_logo_url; endif;?>"
                        alt="Gorg logo" />
                </a>
                        ...
                        <div class="search-overlay">
                            ...
                            <div class="search_wrap">
                                <form action="<?php echo home_url('/');?>">
                                    <input type="text" placeholder="<?php echo pll__('Search');?>" name="s"
