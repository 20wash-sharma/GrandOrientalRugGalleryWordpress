...
abstract class QuoteupEdit
{
    ...
    */
    ...
    public function editQuoteDetails()
    {
        ...
        // validate enquiry whenever a vendor tries to edit any enquiry
                ...
                <section class='wdm-tbl-gen-sec clearfix wdm-tbl-gen-sec-1'>
                    ...
                    ?>
                        <div class='wdm-user' title='<?php echo $this->enquiry_details['name']; ?>'>
                            <input id="input-name" type='text' value='<?php echo $this->enquiry_details['name']; ?>' class='wdm-input input-field input-name' disabled name='cust_name' required>
                    ...
                    ?>
                        <div class='wdm-user-email' title='<?php echo $this->enquiry_details['email']; ?>'>
                            <input id="input-email" type='email' value='<?php echo $this->enquiry_details['email']; ?>' class='wdm-input input-field input-email' disabled name='cust_email' required>
    ...
    */
    public function getPhoneNumberField($form_data)
    {
        ...
        if ($enable_ph == 1) {
            ...
            ?>
            <div class='wdm-user-telephone' title='<?php echo $phNumber; ?>'>
                <input type='text' value='<?php echo $phNumber; ?>' class='wdm-input-telephone wdm-input' disabled name='cust_telephone' required>
    ...
    */
    public function getDateField($form_data)
    {
        ...
        if ($enable_dt == 1) {
            ...
            <div class='wdm-user-date-field' title='<?php echo $dateField; ?>'>
                <input type='text' value='<?php echo $dateField; ?>' class='wdm-input-telephone wdm-input' disabled name='cust_date_field' required>
