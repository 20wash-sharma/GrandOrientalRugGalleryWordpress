...
<title>[_site_title]</title>
	...
	<body style="margin: 0; padding: 0">
		<table width="100%" cellpadding="0" bgcolor="#222222" cellspacing="0" border="0" style="background-image: url([plugin_url]admin/assets/images/table-bg.png); background-color: #222222; padding-top: 20px;">
			<tr>
				<td align="center">
											...
											<tbody>
												...
												<tr>
													<td style="padding-bottom: 100px;">
														<div style="color: #f18f4e; font-size: 30px; text-align: center; font-family: Courier, Courier New, monospace, Arial; font-weight: bold; margin-bottom: 20px;">Congratulations</div>
						...
						<table width="100%" cellpadding="0" cellspacing="0" border="0" style="">
							<tr>
								<td style="font-family: Courier, Courier New, monospace, Arial; font-weight: normal; font-size: 14px; line-height: 24px; color: #ffffff; text-align: left; padding-bottom: 30px; padding-top: 15px; padding-left: 15px; padding-right: 15px;">
									Copyright &copy; [date_year] <a href="[_site_url]" target="_blank" style="text-decoration: none; font-weight: bold; color: #ffffff">[_site_title]</a>
								</td>
