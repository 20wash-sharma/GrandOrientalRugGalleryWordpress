...
?>
<div class="wcpf-item wcpf-radio-item <?php echo implode( ' ', $item_classes ); ?>" data-item-key="<?php echo esc_attr( $item['key'] ); ?>">
        ...
        <div class="wcpf-item-label wcpf-radio-label">
            <div class="wcpf-input-container">
                <input class="wcpf-input wcpf-input-radio"
                    ...
                    <?php if ( $item['option_is_set'] ): ?> checked<?php endif; ?>
                    <?php if ( $item['disabled'] ): ?> disabled<?php endif; ?>>
            </div>
            ...
            <div class="wcpf-item-children-container wcpf-radio-children-container">
                <?php
                    foreach ( $item['children'] as $child_item ) {
                        $template_loader->render_template( 'field/radio-item.php', [
                            'item' => $child_item,
