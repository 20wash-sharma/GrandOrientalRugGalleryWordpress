...
<div class="<?php echo implode( ' ', $field_class ); ?>">
    <div class="wcpf-inner">
        ...
        <?php endif; ?>
        <div class="wcpf-drop-down-list field-input-container wcpf-content"<?php if ( $is_hide ): ?> style="display: none;"<?php endif; ?>>
            <select class="wcpf-input wcpf-input-drop-down wcpf-drop-down-style-<?php echo $drop_down_style; ?>"
                    name="<?php echo esc_attr( $filter_key ); ?>">
                <?php
                    foreach ( $option_items as $item ) {
                        $template_loader->render_template( 'field/drop-down-item.php', [
                            'item' => $item,
