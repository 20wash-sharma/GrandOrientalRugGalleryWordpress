...
class Template_Loader extends Structure\Component {
    ...
    public function get_template_locate( $template_name, $path = null ) {
        if ( $path ) {
            ...
            $template = locate_template( [ trailingslashit( $this->get_plugin()->get_plugin_uri() ) . $template_name ] );
    ...
    public function render_template( $template_name, array $context = [], $path = null ) {
    ...
    public function compile_template( $template_name, array $context = [], $path = null ) {
