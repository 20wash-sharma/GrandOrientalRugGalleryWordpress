...
class Loader extends Structure\Component {
    ...
    public function load_assets() {
        ...
        foreach ( $this->data['editor']['panels'] as $panelKey => $panel ) {
            $panels_data[ $panelKey ] = $panel->get_structure();
        }
    ...
    protected function create_route( $links ) {
        ...
        } else if ( $screen->base == 'post' && $screen->action == 'add' ) {
