...
class Rules_Builder_Control extends Abstract_Control {
    ...
    public function get_structure() {
        return array_merge( parent::get_structure(), [
            ...
            'groupRuleTemplateHtml' => $this->get_template_loader()->compile_template( 'parts/group-rule-template.php', [], $this->template_root_path )
        ] );
    }

    public function render_control() {
        $this->render( 'control/rules-builder.php', [
            'use_entries' => $this->get_use_entries(),
