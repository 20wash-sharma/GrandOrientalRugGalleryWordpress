    ...
    <div class="row justify-content-center">
        <div class="no-results not-found justify-content-center">
            <header class="page-header text-center">
                <h1 class="page-title"><?php esc_html_e(pll__('Nothing Found'), 'gorg' ); ?></h1>
            </header><!-- .page-header -->
            ...
            <div class="page-content text-center">
                ...
                <p><?php esc_html_e(pll__('Sorry, but nothing matched your search terms. Please try again with some different keywords.'), 'gorg' ); ?>
                </p>
                ...
                <p><?php esc_html_e(pll__('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.'), 'gorg' ); ?>
                </p>
                <div class="search_form pt-3 pb-4">
                    <form action="<?php echo home_url('/');?>" class="position-relative">
                        <input name="s" id="text" data-email="required" type="text"
