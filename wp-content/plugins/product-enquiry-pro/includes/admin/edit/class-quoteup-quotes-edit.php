        ...
        foreach ($quoteProducts as $singleProduct) {
            ...
            ?>
                            ...
                            <td class="wdmpe-detailtbl-content-item item-content-qty" >
                                <input data-row-num="<?php echo $count; ?>" id="content-qty-<?php echo $count ?>" class="newqty <?php echo ' '.$varProduct;?>" type="number" name="newqty" value="<?php echo $singleProduct['quantity']; ?>" min="0" <?php echo $quotationDisabled.' '.$productDisabled.' '.$disableInputboxes.' '.$inputOff.' '.$enquiryAnonymizedDisabled; ?> >
                            </td>
        ...
        if (in_array('quote-options', $showFields)) {
            ...
            <div class="quote-options">
                ...
                <div class ="show-price-option">
                        ...
                        <label for="show_price" class="<?php echo $disabledClass; ?>"><?php _e('Show Old Price in Quotation', QUOTEUP_TEXT_DOMAIN) ?></label> <br />
                        <?php
                        $sendQuotationStatus = '';
