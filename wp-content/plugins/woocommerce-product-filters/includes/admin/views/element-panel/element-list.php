    ...
    <div class="control-content">
        <?php foreach ( $elements as $element ): ?>
            <div class="element-item"
                 ...
                 <?php if ( isset( $element['default_state'] ) && is_array( $element['default_state'] ) ): ?>data-default-state="<?php echo esc_attr( json_encode( $element['default_state'] ) ); ?>"<?php endif; ?>>
                <div class="element-item-inner">
                    ...
                    <div class="element-title-container">
                        <div class="element-title">
                            <span class="text"><?php echo $element['title']; ?></span>
                        </div>
                    </div>
                </div>
            </div>
