    ...
    public function displayBubble()
    {
        ...
        <div id="wdm-cart-count" style="display:none" <?php echo $dataAttr; ?>>
            ...
            echo ' added for enquiry'; ?>">
                <span class='wdm-quoteupicon wdm-quoteupicon-list'></span><span class='wdm-quoteupicon-count'><?php echo $count_val; ?></span>
            </a>
        </div>
        <?php
        do_action('quoteup_after_enquiry_cart_bubble_displayed', $count_val);
    }
}
